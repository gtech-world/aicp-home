...
const SvgLogo = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={200} height={200} {...props}>
    <defs>
      <linearGradient id="logo_svg__a" x1="62.102%" x2="108.197%" y1="0%" y2="37.864%">
        <stop offset="0%" stopColor="#4285EB" />
        <stop offset="100%" stopColor="#2EC7FF" />
      </linearGradient>
      <linearGradient id="logo_svg__b" x1="69.644%" x2="54.043%" y1="0%" y2="108.457%">
        <stop offset="0%" stopColor="#29CDFF" />
        <stop offset="37.86%" stopColor="#148EFF" />
        <stop offset="100%" stopColor="#0A60FF" />
      </linearGradient>
      <linearGradient id="logo_svg__c" x1="69.691%" x2="16.723%" y1="-12.974%" y2="117.391%">
        <stop offset="0%" stopColor="#FA816E" />
        <stop offset="41.473%" stopColor="#F74A5C" />
        <stop offset="100%" stopColor="#F51D2C" />
      </linearGradient>
      <linearGradient id="logo_svg__d" x1="68.128%" x2="30.44%" y1="-35.691%" y2="114.943%">
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <ellipse cx={100.519} cy={100.437} fill="url(#logo_svg__d)" rx={23.6} ry={23.581} />
    </g>
  </svg>
);
